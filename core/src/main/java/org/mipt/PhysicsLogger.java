...
public class PhysicsLogger {
  ...
  private final FileWriter tempWriter;
  ...
  public PhysicsLogger(String fileName) throws IOException {
    ...
    tempWriter = new FileWriter(fileName + "_TT.csv");
  ...
  public void logTT(double wallTemp, double gasTemp) throws IOException {
    tempWriter.write(Double.toString(wallTemp));
    tempWriter.write(',');
    tempWriter.write(Double.toString(gasTemp));
    tempWriter.write('\n');
  }
